...
function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-muted opacity-70 transition-opacity hover:bg-white/[0.06] hover:opacity-100 focus-visible:outline-none">
          <X className="size-4" />
